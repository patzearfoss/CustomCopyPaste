...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    PZMasterViewController *masterViewController = [[PZMasterViewController alloc] initWithNibName:@"PZMasterViewController" bundle:nil];
    UINavigationController *masterNavigationController = [[UINavigationController alloc] initWithRootViewController:masterViewController];

    PZDetailViewController *detailViewController = [[PZDetailViewController alloc] initWithNibName:@"PZDetailViewController" bundle:nil];
